...
INSERT INTO `users` (`id`, `surname`, `username`, `secondname`, `curRank`, `root`, `password`, `salt`, `joinDate`, `dateBirth`, `club`, `avatars`, `rank`) VALUES (NULL, 'Ershov', 'George', 'Dmitrievich', '1', '2', '123', 'salt',  '1970-01-01', '2001-05-05', 'cyberpunk', 'none', 'Мастер');
INSERT INTO `ranks` (`rankId`, `id`, `dateTake`, `urlImg`, `nameRank`,`prevRank`) VALUES (NULL, '1', '2021-12-25', 'none', '1', '0');
INSERT INTO `payments` (`payId`, `id`, `yearPay`, `datePay`, `sumPay`) VALUES (NULL, '1', '2017-01-01', '2021-12-27', '1000');


CREATE TABLE  IF NOT EXISTS uploadExcel (
...
ALTER TABLE uploadExcel add CONSTRAINT FK_uploadExcel_users
    FOREIGN KEY uploadExcel(id)
    REFERENCES users(id);

CREATE TABLE  IF NOT EXISTS uploadExcelUsers (
    uid INT (27) NOT NULL AUTO_INCREMENT PRIMARY KEY,
    id int (7),
    dateUpload int not null,
    fileSize int not null,
